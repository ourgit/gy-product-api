...
public class BusinessConstant {
     ...
     * 支付方式,现金，该类型用于充值
     */
    public static final int PAYMENT_CASH = 5;
     ...
     * 支付方式,9先欠款
     */
    public static final int PAYMENT_DEBET = 9;
    /**
     * 支付方式,10金尊金融
     */
    public static final int PAYMENT_JZJR = 10;
    /**
     * 支付方式,11定金支付
     */
    ...
    public static final String OPERATION_FAV_PRODUCT = "OPERATION_FAV_PRODUCT";
    public static final String OPERATION_FAV_SHOP = "OPERATION_FAV_SHOP";
    ...
    public static final String CARD_COUPON_FOR_ASSIST = "CARD_COUPON_FOR_ASSIST";
}
